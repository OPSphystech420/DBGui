...
public:
	...
	inline int GetLineCount() const { return m_Lines.size(); }
	...
	bool Render(const char* aTitle, bool aParentIsFocused = false, const ImVec2& aSize = ImVec2(), bool bBackground = false, bool bBorder = false);
